...
allValues condition (Node a x y) = condition a
                                   && allValues condition x
                                   && allValues condition y
...
isOrdered (Node a Empty j@(Node y _ _)) = a < y && isOrdered j
isOrdered (Node a i@(Node x _ _) Empty) = x < a && isOrdered i
isOrdered (Node a i@(Node x _ _) j@(Node y _ _)) = x < a && a < y
                                                   && isOrdered i
                                                   && isOrdered j
